...
3. Менеджер заповнює форму (назва проєкту, команда).
4. Менеджер натискає кнопку "Створити проєкт".
5. Система створює новий проєкт. (PrjCreate_EX_EmptyName)
...
1. Менеджер/розробник натискає на кнопку/іконку "Показати артефакти".
