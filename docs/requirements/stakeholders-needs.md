...
Директорії для збереження даних не існує. (FileCreation_1.1_IncorrectDirectory)

Пам'яті в системі для збереження резервної копії недостатньо. (FileCreation_1.1_lowMemory)

Проєкт пустий. (FileCreation_1.1_emptyProject)
...
4. Cистема отримує директорію. (FileCreation_1.1_IncorrectDirectory)
5. Cистема здійснює обробку даних.
6. Cистема записує дані у вихідний файл. (FileCreation_1.1_lowMemory)

***ID:*** ProjectRestoration_1.1
...
Резервна копія некоректна. (ProjectRestoration_1.1_sourceIncorrect)
...
4. Cистема отримує файл. (ProjectRestoration_1.1_sourceIncorrect)
5. Cистема здійснює обробку даних.
