...
Цей документ відповідає запитам зацікавлених осіб щодо особливостей та функціональності нашої системи управління проєктами - Cringellо. Вимоги вказані в документі є основою для розробки нашого проєкту.
...
Розробник - людина, які займаеться розробкою проекту. Розробник може бути тімлідом(він взаємодіє з менеджером та ставить завдання до команди). Він взаємодіє безпосередньо з тімлідом(інший розробник), але не взаємодіє з менеджером.
