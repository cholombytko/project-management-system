...
PrjCreate_EX_EmptyName Поле назви проєкту залишиться пустим.
...
TeaMan_1.1_EX_EmptyName Поле назви команди залишиться пустим.
TeaMan_1.1_EX_FileSize Система видає помилку в разі введення некоректної інформації: іконка команди - обсяг файлу завеликий(макс. 2 мб).
...
TeaMan_1.3_EX_NoUser Система не знаходить користувача в базі та видає помилку про ненаход.
...
TaskChange_EX_EmptyName Поле назви завдання пусте.
TaskChange_EX_EmptyDescr Поле опису завдання пусте.
...
TaskViewChange_EX_NoDeadline Завдання не має дедлайну.
TaskViewChange_EX_NoArtefact Завдання не має закріпленого артефакту.
...
PrjBackup_EX_IncorrectDirectory Директорії для збереження даних не існує.
PrjBackup_EX_LowMemory Пам'яті в системі для збереження резервної копії недостатньо.
PrjBackup_EX_EmptyProject Проєкт пустий.
...
PrjRestor_EX_sourceIncorrect Резервна копія некоректна.
